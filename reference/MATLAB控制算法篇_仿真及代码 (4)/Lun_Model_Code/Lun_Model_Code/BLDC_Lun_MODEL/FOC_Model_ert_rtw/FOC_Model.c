                      ...
                      *rty_LunWm, real_T *rty_RestsSingal, DW_Curr_loop *localDW)
{
   ...
   case 2:
    {
       ...
       *  Math: '<S8>/Mod'
       */
      localDW->Merge = rt_modf_snf(DiscreteTimeIntegrator1_n, 6.28318548F);
   ...
   case 3:
    {
       ...
       */
      localDW->Merge = rt_modf_snf(DiscreteTimeIntegrator, 6.28318548F);
  ...
  if (rtb_SignPreSat_g > 12.4707661F) {
    rtb_ZeroGain_ej = 12.4707661F;
  } else if (rtb_SignPreSat_g < -12.4707661F) {
    rtb_ZeroGain_ej = -12.4707661F;
  } else {
    rtb_ZeroGain_ej = rtb_SignPreSat_g;
  }
  ...
  In_park(rtb_ZeroGain_m, rtb_ZeroGain_ej, rtb_Sin, rtb_Cos, &ualpha, &ubeta);
  ...
  if (DiscreteTimeIntegrator > 6283.18555F) {
    rtb_Sin = 6283.18555F;
  } else if (DiscreteTimeIntegrator < -6283.18555F) {
    rtb_Sin = -6283.18555F;
  } else {
  ...
  *rty_LunWm = 1.0F / motor.Pn * rtb_Sin * 9.54929638F;
  ...
  /* Gain: '<S48>/ZeroGain' */
  rtb_ZeroGain_m = 0.0F * DiscreteTimeIntegrator;
   ...
   */
  if ((rtb_ZeroGain_m != DiscreteTimeIntegrator) && ((int8_T)rtb_Gain21 ==
       (int8_T)rtb_Gain23)) {
  ...
  *rty_Tcmp3 = rty_Tcmp1[2];
  ...
  /* Gain: '<S106>/ZeroGain' */
  rtb_ZeroGain_ej = 0.0F * rtb_SignPreSat;
  ...
  /* Gain: '<S156>/ZeroGain' */
  rtb_Sum1_j = 0.0F * rtb_SignPreSat_g;
   ...
   */
  if ((rtb_ZeroGain_ej != rtb_SignPreSat) && ((int8_T)rtb_ZeroGain_m ==
       Integrator_g)) {
  ...
  if (rtb_SignPreSat_g < 0.0F) {
    rtb_ZeroGain_ej = -1.0F;
  } else if (rtb_SignPreSat_g > 0.0F) {
    rtb_ZeroGain_ej = 1.0F;
  } else if (rtb_SignPreSat_g == 0.0F) {
    rtb_ZeroGain_ej = 0.0F;
  } else {
    rtb_ZeroGain_ej = (rtNaNF);
  }
   ...
   */
  if ((rtb_Sum1_j != rtb_SignPreSat_g) && ((int8_T)rtb_ZeroGain_ej == (int8_T)
       rtb_SignPreSat)) {
...
void FOC_Model_step(void)
{
  ...
  if (rtM->Timing.TaskCounters.TID[1] == 0) {
    ...
    if (rtb_IntegralGain < 0.0F) {
      ...
      rtb_IntegralGain_0 = 0.0F;
    } else {
      rtb_IntegralGain_0 = (rtNaNF);
    }
